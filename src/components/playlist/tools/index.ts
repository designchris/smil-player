...
export function createHtmlElement(htmlElement: string, filepath: string, regionInfo: RegionAttributes, isTrigger: boolean = false): HTMLElement {
	...
	if (isTrigger) {
		console.log('creating html element trigger ' + filepath);
